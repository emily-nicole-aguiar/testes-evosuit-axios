...
public class Ajax_ESTest extends Ajax_ESTest_scaffolding {
  ...
  public void test0()  throws Throwable  {
      ...
      Axios axios0 = new Axios("+y", requestMethod0, request0);
  ...
  public void test4()  throws Throwable  {
      ...
      Request request0 = new Request();
      Header header0 = new Header();
      Axios axios0 = new Axios(",6f()Tw4..Qsstx-z.Z", requestMethod0, request0, (Body) null, header0);
      axios0.setUrl("~`)7-WbVLod;&Z5o");
      try { 
        axios0.ajax();
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Illegal character in authority at index 7: http://~`)7-WbVLod;&Z5o/
         //
         verifyException("com.axios.core.tool.UrlTool", e);
      }
  }
