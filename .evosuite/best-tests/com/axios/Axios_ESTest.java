...
public class Axios_ESTest extends Axios_ESTest_scaffolding {
  ...
  public void test017()  throws Throwable  {
      Body body0 = new Body();
      try { 
        Axios.post("com.axios.Axios", body0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test026()  throws Throwable  {
      Request request0 = new Request();
      try { 
        Axios.get("J])'dpQ", request0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Illegal character in hostname at index 8: http://J])'dpQ/
         //
  ...
  public void test027()  throws Throwable  {
      Request request0 = new Request();
      try { 
        Axios.get("aZv%>}i8Dsxra20", request0);
        fail("Expecting exception: NullPointerException");
  ...
  public void test037()  throws Throwable  {
      Request request0 = new Request();
      try { 
        Axios.delete("5{?rD", request0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Illegal character in authority at index 7: http://5{/?rD
         //
         verifyException("com.axios.core.tool.UrlTool", e);
      }
  }
  ...
  public void test039()  throws Throwable  {
      try { 
        Axios.delete("KK\u0006e: tY}*31A", (Header) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test052()  throws Throwable  {
      ...
      Axios axios0 = null;
      try {
        axios0 = new Axios("AVW2xgNX[*[LaO%VY0!", requestMethod0, request0, (Header) null);
        fail("Expecting exception: RuntimeException");
  ...
  public void test068()  throws Throwable  {
      ...
      Axios axios0 = null;
      try {
        axios0 = new Axios("POST", requestMethod0);
        fail("Expecting exception: RuntimeException");
  ...
  public void test084()  throws Throwable  {
      Header header0 = new Header();
      try { 
        Axios.put("`59':", header0);
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Illegal character in authority at index 7: http://`59'/
         //
         verifyException("com.axios.core.tool.UrlTool", e);
      }
  }
  ...
  public void test086()  throws Throwable  {
      try { 
        Axios.put("HttpURLConnection has ot been initialized.");
        fail("Expecting exception: RuntimeException");
      
      } catch(RuntimeException e) {
         //
         // Illegal character in authority at index 7: http://HttpURLConnection has ot been initialized./
         //
         verifyException("com.axios.core.tool.UrlTool", e);
      }
  }
  ...
  public void test088()  throws Throwable  {
      try { 
        ...
        fail("Expecting exception: RuntimeException");
         ...
         //
         // Illegal character in authority at index 7: http://}^JO7D|/
         //
         verifyException("com.axios.core.tool.UrlTool", e);
      }
  }
  ...
  public void test090()  throws Throwable  {
      RequestMethod requestMethod0 = RequestMethod.HEAD;
      Body body0 = new Body();
      Axios axios0 = new Axios("ae", requestMethod0, body0);
  ...
  public void test098()  throws Throwable  {
      RequestMethod requestMethod0 = RequestMethod.TRACE;
      Request request0 = new Request();
      Axios axios0 = new Axios("2W", requestMethod0, request0);
      assertEquals(RequestMethod.TRACE, axios0.getMethod());
  }
  ...
  public void test100()  throws Throwable  {
      ...
      assertSame(requestMethod1, requestMethod0);
  }
