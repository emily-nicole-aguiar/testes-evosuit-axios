...
public class HttpBase_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.axios.core.http.HttpBase"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(HttpBase_ESTest_scaffolding.class.getClassLoader() ,
      "com.axios.core.tool.random.RandomTool",
      ...
      "com.axios.core.body.MultipartBody",
      ...
      "com.axios.core.body.RequestBody",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("java.net.CookiePolicy", false, HttpBase_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(HttpBase_ESTest_scaffolding.class.getClassLoader()); 
