...
public class CustomProtocolsSSLFactory_ESTest extends CustomProtocolsSSLFactory_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          ...
          try { 
            customProtocolsSSLFactory0.createSocket(inetAddress0, 0, inetAddress1, 1);
  ...
  public void test04()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        customProtocolsSSLFactory0.createSocket((String) null, (-850));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-850
         //
         verifyException("java.net.InetSocketAddress", e);
      }
  }
  ...
  public void test06()  throws Throwable  {
      CustomProtocolsSSLFactory customProtocolsSSLFactory0 = new CustomProtocolsSSLFactory((String[]) null);
      String[] stringArray0 = customProtocolsSSLFactory0.getDefaultCipherSuites();
  ...
  public void test08()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        customProtocolsSSLFactory0.createSocket("com.axios.exception.IORuntimeException", (-583), (InetAddress) null, (-583));
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test09()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        customProtocolsSSLFactory0.createSocket(inetAddress0, (-469), inetAddress0, (-469));
        fail("Expecting exception: IllegalArgumentException");
      
      } catch(IllegalArgumentException e) {
         //
         // port out of range:-469
         //
         verifyException("java.net.InetSocketAddress", e);
      }
  }
