...
public class MoveVisitor_ESTest extends MoveVisitor_ESTest_scaffolding {
  ...
  public void test5()  throws Throwable  {
      ...
      FileVisitResult fileVisitResult0 = moveVisitor0.preVisitDirectory(path0, basicFileAttributes1);
      FileVisitResult fileVisitResult1 = moveVisitor0.preVisitDirectory(path0, basicFileAttributes0);
  ...
  public void test6()  throws Throwable  {
    Future<?> future = executor.submit(new Runnable(){ 
        ...
        try {
          ...
          Path path0 = mockFile0.toPath();
          MoveVisitor moveVisitor0 = new MoveVisitor(path0, path0, (CopyOption[]) null);
          MockFile mockFile1 = new MockFile("Z$l{US");
          Path path1 = mockFile1.toPath();
          BasicFileAttributes basicFileAttributes0 = mock(BasicFileAttributes.class, new ViolatedAssumptionAnswer());
          // Undeclared exception!
          try { 
            ...
            fail("Expecting exception: SecurityException");
             ...
             //
             // Security manager blocks (\"java.io.FilePermission\" \"Z$l{US\" \"write\")
